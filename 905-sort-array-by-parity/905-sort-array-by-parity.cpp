...
//          We take two variable left as "l" and right as "r" we intialize left as zero and right as the nums.size( )-1 (the last value of array ) and start the loop until left is smaller than right.
